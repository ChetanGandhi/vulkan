...
XR_API VkResult xrInitInstance(XrContext *context);
...
VkPresentModeKHR xrChoosePresentMode(XrContext *context, const std::vector<VkPresentModeKHR> &presentModes);
void xrChooseSurfaceExtent(XrContext *context, VkSurfaceCapabilitiesKHR surfaceCapabilities, VkExtent2D *initialSurfaceExtent);
...
void xrPrintGpuProperties(XrContext *context, XrGpuDetails *details, uint32_t currentGpuIndex, uint32_t totalGpuCount);
